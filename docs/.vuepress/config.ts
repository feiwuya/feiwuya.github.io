...
const DOMAIN_NAME = 'feiwuya.github.io' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:3020766090@qq.com',
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/feiwuya',
        },
      ],
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'null', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
  ...
  head: [
    ...
    [
      ...
      {
        name: 'keywords',
        content: 'Java,Spring,SpringBoot,SpringCloud',
      },
    ],
